...
public final class ServerConfigurationAddDiscordSubCommand extends DiscordSubCommand {
    // Public constructor.
    public ServerConfigurationAddDiscordSubCommand () {
        super("add", new String[] {"Server ID", "Owner Role ID", "Admin Role ID", "Moderator Role ID", "Verification Role ID", "Bot Information Channel ID", "Logging Channel ID", "Verification Channel ID"}, 8);
    }
